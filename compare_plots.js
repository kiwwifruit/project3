...
//         const labels = Array.from({ length: 181 }, (_, i) => i); // Create labels from 0 to 180
//         const data = new Array(181).fill(null); // Initialize all with null for blank sections
...
//         const sum = data.filter(v => v !== null).reduce((acc, val) => acc + val, 0);
...
//             minY: Math.min(...data.filter(v => v !== null)),
//             maxY: Math.max(...data.filter(v => v !== null))
//         };
//     }
...
//             minY = Math.floor(minY / 10) * 10; // Round down to nearest 10
...
//                             max: 180,
//                             ticks: {
//                                 stepSize: 20, // Ensures evenly spaced labels
//                             }
//                         },
//                         y: {
//                             title: {
...
//                                 text: 'Value'
//                             },
//                             min: chartData.alignedMinY,
//                             max: chartData.alignedMaxY
//                         }
//                     },
//                     annotation: {
//                         annotations: {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function getFilePathsForFeature(feature) {
        switch (feature) {
            ...
            case 'eda': return ['eda/eda_S10_Midterm1.csv', 'eda/eda_S6_Midterm1.csv'];
